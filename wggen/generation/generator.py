...
from .wg_config import ConfigSection, WGConfig
...
class WGGenerator:
    ...
    def __init__(
        ...
        self._server_port = 51820 + self._server_number
    ...
    def _generate_peer_keys(self) -> None:
    ...
    def _generate_configs(self) -> None:
        ...
        for group in self._group_list:
            ...
            for peer in range(self._peers_in_group):
                peer_subnet = list(cur_net.subnet(32))[1 + peer]
